...
import com.zhaojh.model.Role;
import com.zhaojh.model.User;
...
public interface UserMapper {
    ...
    @Results({
            ...
            @Result(column = "phone", property = "roles", javaType = List.class, many = @Many(select = "com.zhaojh.mapper.UserMapper.getRoleNameByPhone")),
    })
